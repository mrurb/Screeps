		    ...
		    function getCreepBody(rname, bratio){
    			...
    			if(bratio){
    			    ...
    			    for(var x in bratio){
    			        ...
    			        //console.log(worka + " : " + _.times(worka, function(){return x;})  );
    			        creepSetup2.push(_.times(worka, function(){return x;}));
		    ...
		    for(var creepRole in creepJson.creeps){
	            ...
	            if (cSize < maxCreeps){
	               /* if(creepJson.creeps[creepRole].bratio){
	                    console.log(getCreepBody(rname, creepJson.creeps[creepRole].bratio));
	                    console.log(spawn.createCreep(getCreepBody(rname, creepJson.creeps[creepRole].bratio), undefined, {role: creepRole, node: 99}) );
                        break;
	                }
